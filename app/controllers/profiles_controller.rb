class ProfilesController < ApplicationController
  ...
  private
    ...
    def profile_params
      params.require(:profile).permit(:avatar, :description, :name, :is_brand, :website, :location, :what_we_make, :brands_we_carry, :looking_for, :stockist_list, :tag_list, :tagline)
    end
